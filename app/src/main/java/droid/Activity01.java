	...
	public void onCreate(Bundle savedInstanceState) {
		...
		personList.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				if (position >= 4) {
					...
					intent.putExtra("citys",allCity_lists.get(position).getName());
		...
		resultList.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent intent = new Intent(Activity01.this, MainActivity.class);
				intent.putExtra("index",1);
				intent.putExtra("citys",	city_result.get(position).getName());
				startActivity(intent);
				Toast.makeText(getApplicationContext(),
			...
			if (viewType == 0) { // 定位
				...
				city.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						if (locateProcess == 2) {
							Intent intent = new Intent(Activity01.this, MainActivity.class);
							intent.putExtra("citys",city.getText());
							intent.putExtra("index",1);
							startActivity(intent);
							Toast.makeText(getApplicationContext(),
				...
				rencentCity.setOnItemClickListener(new OnItemClickListener() {
					...
					public void onItemClick(AdapterView<?> parent, View view,
											int position, long id) {
						Intent intent = new Intent(Activity01.this, MainActivity.class);
						intent.putExtra("citys",city_history.get(position));
						intent.putExtra("index",1);
						startActivity(intent);
						Toast.makeText(getApplicationContext(),
				...
				hotCity.setOnItemClickListener(new OnItemClickListener() {
					...
					public void onItemClick(AdapterView<?> parent, View view,
											int position, long id) {
						Intent intent = new Intent(Activity01.this, MainActivity.class);
						intent.putExtra("citys",city_hot.get(position).getName());
						intent.putExtra("index",1);
						startActivity(intent);
						Toast.makeText(getApplicationContext(),
